.onAttach <- function(...) {
  msg(cli::rule(crayon::bold("International Trade and Production Database for Estimation (ITPD-E)")))
  msg(" ")
  msg("The package documentation and usage examples can be found at https://pacha.dev/itpde/.")
